...
from data.test_data_process_command import (
    BASE_PARAMS, PARAMS_ALLOW_NONE_VALUE_NONE,
    PARAMS_ALLOW_NONE_VALUE_WITH_VALUE, PARAMS_CURRENT_YEAR,
    PARAMS_FIRST_ITEM_FROM_LIST, PARAMS_FIRST_ITEM_FROM_LIST_NONE_RESULT,
    PARAMS_FROM_LIST, PARAMS_FULL_RECORD, PARAMS_GET_FIXED_VALUE,
    PARAMS_INT_FROM_STRING, PARAMS_JOIN, PARAMS_JOIN_ERROR,
    PARAMS_JOIN_KEY_VALUE, PARAMS_JOIN_KEY_VALUE2,
    PARAMS_JOIN_KEY_VALUE_ERROR1, PARAMS_JOIN_KEY_VALUE_ERROR2,
    PARAMS_JOIN_KEY_VALUE_ERROR3, PARAMS_JOIN_WITH_FIXED_VALUE,
    PARAMS_JOIN_WITH_SEPERATOR, PARAMS_JOIN_WITH_SEPERATOR_AND_NONE,
    PARAMS_NON_EXIST_COMM, PARAMS_POINT, PARAMS_POINT_ERROR1,
    PARAMS_POINT_ERROR2, PARAMS_SET_TO_NONE_VALUE, PARAMS_SPLIT_FIELD,
    PARAMS_SPLIT_FIELD_NONE, PARAMS_TO_INT_STRIP_LIST, PARAMS_TO_INT_STRIP_STR,
    PARAMS_TO_LIST, PARAMS_TO_LIST_DYNAMIC)
